...
public class ActivityLoaderActivity extends Activity {
    ...
    private void startExplicitActivation() {
        ...
        Intent explicitlyLoadedActivity = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
    ...
    private void startImplicitActivation() {
        ...
        chooserIntent = Intent.createChooser(urlIntent, CHOOSER_TEXT);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GET_TEXT_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                String inputFromExpAct = data.getStringExtra(ExplicitlyLoadedActivity.KEY);
                mUserTextView.setText(inputFromExpAct);
            }
        }
